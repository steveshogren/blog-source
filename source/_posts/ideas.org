...
team and code base that only can sustain 30-40 units. What they want just isn't
...
developers to a late project makes it later." 

## Suggestions

+ *For the technical staff:* How accurate are your estimates and velocity? Do you
  regularly under-estimate your stories? Do developers often say, "oh, that's
  only..."? 
  ...
  out without much thought won't help. Take care to do your best to consider the
  actual cost of the final job. If you regularly have inaccurate estimates in a
  certain area of the system, put extra care into those estimates.
...
+ *For the business:* There is only so many units of productivity that fit into
  ...
  accomplished in a given time frame. You need to assess every story, given
  every estimate, and consider the risk with each.

What adds to the complexity is many types of development projects are very
