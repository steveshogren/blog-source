...
* Three Years of Self Organizing Teams
...
+ No team may determine business priority
...
single person has to be a point of failure or bottleneck for all these subjects,
instead each developer has specialized in a few. If any one person leaves, a few
others have enough knowledge to fill in any gaps while learning more.
...
+ Productivity next year needs to be sacrificed for features this month
